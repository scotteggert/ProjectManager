...
{
    public class EstimatorIntegrationEventService: IEstimatorIntegrationEventService
    {
        ...
        {
            _estimatorContext = estimatorContext ?? throw new ArgumentNullException(nameof(estimatorContext));
