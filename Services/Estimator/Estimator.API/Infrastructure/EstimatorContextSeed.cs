...
{
//    public async Task SeedAsync(EstimatorContext context, IWebHostEnvironment env, IOptions<EstimatorSettings> settings, ILogger<EstimatorContextSeed> logger)
//    {
//        var policy = CreatePolicy(logger, nameof(EstimatorContextSeed));
...
//    private IEnumerable<CardType> GetCardTypesFromFile(string contentRootPath, ILogger<EstimatorContextSeed> log)
//    {
...
//    private IEnumerable<OrderStatus> GetOrderStatusFromFile(string contentRootPath, ILogger<EstimatorContextSeed> log)
//    {
...
//    private AsyncRetryPolicy CreatePolicy(ILogger<EstimatorContextSeed> logger, string prefix, int retries = 3)
//    {
